...
unlocked to sign the BitcoinV1-Qt.app bundle.
...
allowing somebody to distribute a BitcoinV1-Qt.app or bitcoinv1-qt-setup.exe with a valid
...
that the bitcoinv1-qt.exe file inside the installer had not been tampered with.
