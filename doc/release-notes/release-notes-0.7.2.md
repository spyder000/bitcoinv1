BitcoinV1 version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoinv1/files/BitcoinV1/bitcoinv1-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused BitcoinV1-Qt to crash on Windows when exiting.
