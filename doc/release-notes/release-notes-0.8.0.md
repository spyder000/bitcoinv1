BitcoinV1-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinv1/files/BitcoinV1/bitcoinv1-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinV1
...
New/changed settings (command-line or bitcoinv1.conf file)
--------------------------------------------------------
