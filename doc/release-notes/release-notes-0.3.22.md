Download URL: https://sourceforge.net/projects/bitcoinv1/files/BitcoinV1/bitcoinv1-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTC1 fee schedule (users still pay 0.01 BTC1 per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinv100 - #bitcoinv199
