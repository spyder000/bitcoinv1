...
*Setup instructions for a gitian build of BitcoinV1 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the BitcoinV1
...
- [Building BitcoinV1](#building-bitcoinv1)
...
Clone the git repositories for bitcoinv1 and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/bitcoinv1/bitcoinv1
```
...
In [doc/release-process.md](release-process.md) in the bitcoinv1 repository under 'Fetch and build inputs'.
...
To build BitcoinV1 (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the bitcoinv1 repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bitcoinv1/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/bitcoinv1/bitcoinv1
...
For example:
```bash
URL=https://github.com/laanwj/bitcoinv1.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit bitcoinv1=${COMMIT} --url bitcoinv1=${URL} ../bitcoinv1/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitcoinv1=${COMMIT} --url bitcoinv1=${URL} ../bitcoinv1/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/bitcoinv1-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/bitcoinv1-build.assert
```
...
[bitcoinv1/gitian.sigs](https://github.com/bitcoinv1/gitian.sigs/) repository, or
