The following is a list of assets used in the bitcoinv1 source and their proper attribution.
...
* License: MIT
* Site: [https://bitcoinv1talk.org/index.php?topic=15276.0](https://bitcoinv1talk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinv1 logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/bitcoinv1.icns, src/qt/res/src/bitcoinv1.svg,
	src/qt/res/src/bitcoinv1.ico, src/qt/res/src/bitcoinv1.png,
	src/qt/res/src/bitcoinv1_testnet.png, docs/bitcoinv1_logo_doxygen.png,
