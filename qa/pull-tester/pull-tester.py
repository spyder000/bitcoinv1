...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old BitcoinV1PullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/BitcoinV1dComparisonTool_jar/BitcoinV1dComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/bitcoinv1/bitcoinv1.git")
...
environ_default("BUILD_PATH", "/mnt/bitcoinv1")
...
environ_default("GITHUB_REPO", "bitcoinv1/bitcoinv1")
