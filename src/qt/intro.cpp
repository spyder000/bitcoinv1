...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitcoinv1"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinV1"),
     ...
     * override -datadir in the bitcoinv1.conf file in the default data directory
     * (to be consistent with bitcoinv1d behavior)
     */
    if(dataDir != getDefaultDataDirectory())
