...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinv1.org", "www.bitcoinv1.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinv1.org]", "www.bitcoinv1.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinv1.org:80", "www.bitcoinv1.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinv1.org]:80", "www.bitcoinv1.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2333", "127.0.0.1", 2333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2333", "127.0.0.1", 2333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2333", "::ffff:127.0.0.1", 2333));
    BOOST_CHECK(TestSplitHost("[::]:2333", "::", 2333));
    BOOST_CHECK(TestSplitHost("::2333", "::2333", -1));
    BOOST_CHECK(TestSplitHost(":2333", "", 2333));
    BOOST_CHECK(TestSplitHost("[]:2333", "", 2333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2333", "127.0.0.1:2333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2333", "[::]:2333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
