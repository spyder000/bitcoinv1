...
#ifndef H_BITCOINV1_SCRIPT
#define H_BITCOINV1_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBitcoinV1Address
 */
...
public:
    ...
    // Pre-version-0.6, BitcoinV1 always counted CHECKMULTISIGs
