...
#ifndef _BITCOINV1RPC_CLIENT_H_
#define _BITCOINV1RPC_CLIENT_H_ 1
...
/** Show help message for bitcoinv1-cli.
 ...
 *
 * @note the argument can be removed once bitcoinv1-cli functionality is removed from bitcoinv1d
 */
