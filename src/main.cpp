...
#if defined(NDEBUG)
# error "BitcoinV1 cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitcoinV1 Signed Message:\n";
...
{
    int64_t nSubsidy = 1200 * COIN;

    if (nHeight == 50) {
	//Premined 1B
	return (1000000000 * COIN) + nFees;
    }
...
void ThreadScriptCheck() {
    RenameThread("bitcoinv1-scriptch");
